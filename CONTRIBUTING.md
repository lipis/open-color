...
5.  **Always run `npm run compile-templates` before sending a PR.**
...
**Note** if you want to add support for a new binary file format, please orient yourself at the usage of our [`.ase` builder](https://github.com/yeun/open-color/blob/master/builder/ase.js).

## TL;DR

**Be kind, be diligent, look before you leap into a PR, and follow common community conventions**.

_- The Open Color Team_

_this contributing guide is heavily inspired by [mocha](https://github.com/mochajs/mocha/blob/master/CONTRIBUTING.md)_
